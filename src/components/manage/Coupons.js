...
const Coupons = ()=>{
  const [open,setOpen] = useState(false)
    ...
    return(
        <div>
            <HeaderComponent name="Coupons" >
                <ButtonGlobal onclick={()=> setOpen(true)} text={"add Coupons"} />
            </HeaderComponent>

          {  open && <Modal handleClose={handleClose} title={"Add Coupons"} >
                        <div className="mb-2"><INputGlobal lable={"Coupons name"} /></div>
